...
def main() -> int:
    ...
    parser.add_argument("--input_dir", type=str, required=True, help="Directory with pca_ablation_results.json")
    parser.add_argument("--output_dir", type=str, default=None, help="Output directory (default: input_dir)")
    ...
    print("=" * 90)
    print("PCA ABLATION VISUALIZATION COMPLETE")
    print("=" * 90)
